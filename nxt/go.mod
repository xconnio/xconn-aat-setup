module github.com/xconnio/xconn-aat-setup
...
require (
	...
	github.com/xconnio/nxt v0.0.0-20250916132745-67bb5cf70387
	...
	github.com/xconnio/xconn-go v0.0.0-20250916112818-d802873b7fe9
